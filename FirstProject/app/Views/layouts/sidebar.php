        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="user">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('/users'); ?>">UserList</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('public/pages/ui-features/buttons.html'); ?>">Buttons</a></li>
                        <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('public/pages/ui-features/dropdowns.html'); ?>">Dropdowns</a></li>
                        <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('public/pages/ui-features/typography.html'); ?>">Typography</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="form-elements">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"><a class="nav-link" href="public/pages/forms/basic_elements.html">Basic Elements</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse" id="charts">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="public/pages/charts/chartjs.html">ChartJs</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse" id="tables">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="public/pages/tables/basic-table.html">Basic table</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse" id="icons">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="public/pages/icons/mdi.html">Mdi icons</a></li>
                    </ul>
                </div>
            </li>
